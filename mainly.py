...
try:
    ...
    py3 = True
def click_checkinn():
    call(["python", "music_player.py"])
def click_list():
    call(["python", "computer.py"])
def click_checkout():
...
class PLAYER:
    def __init__(self):
        ...
        self.bg1=ImageTk.PhotoImage(file="fit.jpg")
        bg1=Label(root,image=self.bg1).place(x=5,y=-5)
        ...
        self.Frame1.configure(borderwidth="20")
        self.Frame1.configure(relief=GROOVE)
        ...
        self.bg1=ImageTk.PhotoImage(file="fit.jpg")
        bg1=Label(self.Frame1,image=self.bg1).place(x=5,y=-5)
        ...
        self.Message6.configure(foreground="sky blue")
        self.Message6.configure(highlightbackground="#d9d9d9")
        self.Message6.configure(highlightcolor="black")
        self.Message6.configure(text='''WELCOME To Desktop''')
        self.Message6.configure(width=791)
        self.Message6.configure(borderwidth="32")
        ...
        self.Button2.configure(text='''1.Music Player''')
        ...
        self.Button3.configure(text='''2.Your Computer''')
        ...
        self.Button5.configure(borderwidth="10")
        ...
        self.Button6.configure(borderwidth="10")
